...
/*   Updated: 2020/10/27 19:05:43 by ericlazo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
int			ft_step_ray(t_game *jeu, t_vect_d *p_pos, t_vect_d *ray)
{
	t_vect_d	side_dist;
	t_vect_d	delta_dist;
	t_vect_i	map;
...
*/
	...
	// could we make this generic enough that it can be used by mouse press

int			ft_shoot_ray(t_game *jeu, t_vect_d p_pos, t_vect_d ray, double *pwd)
{
//	int		side;

//	ft_step_ray(jeu, p_pos, ray);
